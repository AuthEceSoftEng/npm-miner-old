...
class Main extends Component {
  ...
  handleChange = event => {
    ...
    let foundPackages = exampleData.filter(word =>
      word.includes(searchFor.name)
    );
    console.log(foundPackages);
    this.props.setAnalyzedPackage({ name: foundPackages[0] });
  };
  ...
  render() {
    return (
      <MainStyle>
        ...
        />
        <h2>{this.props.analyzedPackage.name}</h2>
        <h2>Main</h2>
        <h2>Main</h2>
        <h2>Main</h2>
      </MainStyle>
